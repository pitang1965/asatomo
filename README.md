...
### 本人の面：Android アプリ「アサトモ目覚まし」

アラームを止めるだけで「元気」が伝わる、本人の日常の道具。ワンタップの近況共有と、
自分が見守っている人の様子もひと目で確認できます。

<p>
  <img alt="Android アプリ（本人・目覚まし）" src="docs/images/android.png" width="300">
</p>

### 見守り者の面：見守り Web（PWA）

下タブで「わたし（自分の状態・旅行モード）」「仲間（見守っている人の近況）」「伝言（最後の伝言の作成）」を切り替えます。

| わたし | 仲間 | 伝言 |
|---|---|---|
| ![見守りWeb・わたし](docs/images/web1.png) | ![見守りWeb・仲間](docs/images/web2.png) | ![見守りWeb・伝言](docs/images/web3.png) |
| 近況共有・見守り者の把握・旅行モード | 見守っている人の「最後にいつ元気だったか」 | ブラウザ内でゼロ知識暗号化する最後の伝言 |

> スクリーンショットの氏名部分はプライバシー配慮のためマスクしています。
